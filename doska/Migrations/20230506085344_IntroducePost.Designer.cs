...
namespace doska.Migrations
{
    ...
    [Migration("20230506085344_IntroducePost")]
    partial class IntroducePost
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("doska.Data.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("doska.Data.Entities.UserRole", b =>
                {
                    b.HasOne("doska.Data.Entities.Role", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("doska.Data.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
